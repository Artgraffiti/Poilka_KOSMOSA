...
(function() {
    ...
    f.prototype = {
        ...
        _arc: function(a, b) {
            var d = a - .001,
                c = a - this._startPrecise < Math.PI ? 0 : 1;
            return ["M", this._radius + this._radiusAdjusted * Math.cos(this._startPrecise), this._radius + this._radiusAdjusted * Math.sin(this._startPrecise),
                "A", this._radiusAdjusted, this._radiusAdjusted, 0, c, 1, this._radius + this._radiusAdjusted * Math.cos(d), this._radius + this._radiusAdjusted * Math.sin(d), b ? "" : "Z"
            ].join(" ")
        },
        _precise: function(a) {
...
(function(e) {
    ...
    var t = e.document.documentElement,
        ...
        i = r[Modernizr.prefixed("animation")];
    o.prototype.options = {
    ...
    o.prototype._init = function() {
        ...
        e += "</div>";
        e += '<span class="ns-close"></span></div>';
        this.ntf.innerHTML = e;
    ...
    o.prototype.dismiss = function() {
        ...
        setTimeout(function() {
            classie.add(e.ntf, "ns-hide");
            e.options.onClose()
        }, 25);
        var t = function(r) {
            if (n.animations) {
                if (r.target !== e.ntf) return false;
                this.removeEventListener(i, t)
            }
            e.options.wrapper.removeChild(this)
        };
        if (n.animations) {
            this.ntf.addEventListener(i, t)
        } else {
            t()
        }
    };
